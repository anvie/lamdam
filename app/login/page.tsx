        ...
        <div className="w-full h-full flex items-center justify-center">
            <div className="w-[502px] flex flex-col space-y-8">
                ...
                <div className="text-center">
                    <div className="mb-4 opacity-90 text-xs font-normal leading-none text-center">Powered by <span className="opacity-80 text-xs font-medium">Neuversity</span></div>
