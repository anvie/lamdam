...
const PromptEditor: FC = () => {
    ...
    const showJumpToRecordDialog = () => {
        ...
        Confirm.prompt(
            ...
            (answer: string) => {
                // jumpt to record
                get(
                    `/api/getRecord?id=${answer}&collectionId=${currentCollection.id}`
                )
                    .then((data: any) => {
    ...
    const onAddNewRecord = () => {
        setGlobalState &&
            setGlobalState({ ...globalState, addNewRecord: true });
    };
    ...
    return (
        <div className="border pb-4">
            ...
            <div className="border-b p-4 grid grid-cols-3 items-center align-middle">
                ...
                <div className="ml-3 flex h-5 items-center space-x-4 text-small gap-2 justify-between">
            ...
            {!chatMode ? (
                <div>
                    <div className="px-4 pt-2">
                        <Textarea
                            ...
                            className="w-full"
                            value={
                                (currentRecord && currentRecord.prompt) || ""
                            }
                    ...
                    >
                        ...
                        {currentCollection?.meta?.dataType === "rm" && (
                            <Textarea
                                ...
                                value={
                                    (currentRecord &&
                                        (currentCollection?.meta?.dataType ===
                                        "rm"
                                            ? currentRecord.outputNegative
                                            : currentRecord.response)) ||
                                    ""
                ...
                <SelectedHistoryContext.Provider
                    value={{ newHistory, setNewHistory }}
                >
